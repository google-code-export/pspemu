module pspemu.core.cpu.tables.Table;
...
/*
const ID[] PspInstructions_ALU = [];
const ID[] PspInstructions_BCU = [];
const ID[] PspInstructions_LSU = [];
const ID[] PspInstructions_FPU = [];
const ID[] PspInstructions_COP0 = [];
const ID[] PspInstructions_VFPU_IMP = [];
